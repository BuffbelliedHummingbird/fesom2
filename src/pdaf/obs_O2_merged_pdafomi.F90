     ...
     ! ---------
      ...
      ! perform loop, checking absolute and relative exclusion criteria
         ...
         DO e2=1, dim_obs_p_sort2
           ...
           emean_fcst = 1.0/3.0 * (    mean_O2_p((nlmax) * (nod1_p_sort2(e2)-1) + nlay_p_sort2(e2)) &
      ...
      DO i = 1, dim_obs_p
        thisobs%id_obs_p(1,i) = (nlmax) * (nod1_p(i)-1) + nlay_p(i) + offset(id%O2)
        thisobs%id_obs_p(2,i) = (nlmax) * (nod2_p(i)-1) + nlay_p(i) + offset(id%O2)
        thisobs%id_obs_p(3,i) = (nlmax) * (nod3_p(i)-1) + nlay_p(i) + offset(id%O2)
      END DO
