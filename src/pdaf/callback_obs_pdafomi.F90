...
! *********************************************
  ...
  ELSEIF (proffiles_o == 2) THEN
     ...
     WRITE(*,*) 'Generation of global file from EN4 raw profile data ', &
                'not yet implemented in FESOM Version 2.1 - stopping!'
     CALL abort_parallel
...
! --------------------------------
SUBROUTINE init_dim_obs_pdafomi_PHY(step, dim_obs)
...
END SUBROUTINE init_dim_obs_pdafomi_PHY
...
! --------------------------------
SUBROUTINE init_dim_obs_pdafomi_BGC(step, dim_obs)

  ! Include functions for different observations
  USE mod_assim_pdaf, &
       ONLY:  mype_debug, node_debug
  USE mod_parallel_pdaf, &
       ONLY: abort_parallel
...
! *********************************************
  ...
  dim_obs =   dim_obs_chl_cci + dim_obs_DIC_glodap + dim_obs_Alk_glodap + dim_obs_pCO2_socat &
            + dim_obs_O2_comf + dim_obs_N_comf + dim_obs_o2_argo + dim_obs_N_argo &
            + dim_obs_O2_merged + dim_obs_n_merged

END SUBROUTINE init_dim_obs_pdafomi_BGC
...
! *** obs_op_pdafomi_PHY ***
! --------------------------
SUBROUTINE obs_op_pdafomi_PHY(step, dim_p, dim_obs, state_p, ostate)
...
END SUBROUTINE obs_op_pdafomi_PHY
...
! *** obs_op_pdafomi_BGC ***
! --------------------------
SUBROUTINE obs_op_pdafomi_BGC(step, dim_p, dim_obs, state_p, ostate)
...
END SUBROUTINE obs_op_pdafomi_BGC
...
! ----------------------------------
SUBROUTINE init_dim_obs_l_pdafomi_PHY(domain_p, step, dim_obs, dim_obs_l)
...
END SUBROUTINE init_dim_obs_l_pdafomi_PHY
...
! ----------------------------------
SUBROUTINE init_dim_obs_l_pdafomi_BGC(domain_p, step, dim_obs, dim_obs_l)
...
END SUBROUTINE init_dim_obs_l_pdafomi_BGC
