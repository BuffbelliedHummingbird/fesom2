...
! ************************************************
  ...
  inpath = '/work/ollie/frbunsen/data/physics/SSS/ESA_SMOS/CORE2/'
  infile = 'SMOS_SSS_'//year_string//'.nc'
  
  ! Path to and name stub of output files
  outpath = '/work/ollie/frbunsen/data/physics/SSS/ESA_SMOS/CORE2/dist_144/'
  outfile = 'SMOS_SSS_'//year_string//'_dist144'
